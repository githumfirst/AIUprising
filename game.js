...
function updateLanguageUI() {
  ...
  // Let's show the Current Language Name
  elBtnLang.textContent = (window.gameLang === 'en' ? '한국어' : 'English'); // Labels the button as the *target* language to switch to, or current?
  // Convention: Button says "한국어" -> Click to switch to Korean. 
  // Button says "English" -> Click to switch to English.
  // So if current is 'en', button should say '한국어'.
  // If current is 'ko', button should say 'English'.
}
updateLanguageUI();
